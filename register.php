...
if(isset($_POST['register'])){
    ...
    if($password !== $confirm_password){
        ...
        $hashed_password = password_hash($password, PASSWORD_DEFAULT); // hashing
        ...
        if(mysqli_num_rows($check) > 0){
            ...
            $insert = mysqli_query($conn, "INSERT INTO customer (name,email,password,contact,address) VALUES ('$name','$email','$hashed_password','$contact','$address')");
            if($insert){
...
<html>
<head>
  <title>Register - PizzaBurg</title>
  <style>
